...
const unitNotes: Record<UnitType, string> = {
  ...
  spy: "Spy unit. Weak in open combat, excellent for stealth and deep reconnaissance while stationary.",
  ...
  chopper: "Chopper gunship built to shred armor and strike fortified ground positions. It can also carry a special-ops team into deep territory.",
