...
function buildUnitSpecialRules(unitType: UnitType) {
  ...
  if (unitType === "submarine") rules.push("Fast attack submarine. Carries torpedoes for sea combat and a cruise missile for land strikes. Can insert Special Ops covertly.");
  if (unitType === "ssbn") rules.push("Missile submarine. Carries many cruise missiles for land strikes but limited torpedo defense.");
